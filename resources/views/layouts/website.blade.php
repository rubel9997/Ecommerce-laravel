...
<link rel="stylesheet" href="{{ 'assets/website/css/blue.css' }}">
<link rel="stylesheet" href="{{ 'assets/website/css/owl.carousel.css' }}">
<link rel="stylesheet" href="{{ 'assets/website/css/owl.transitions.css' }}">
<link rel="stylesheet" href="{{ 'assets/website/css/animate.min.css' }}">
<link rel="stylesheet" href="{{ 'assets/website/css/rateit.css' }}">
...
<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
    <!-- ============================================================= LOGO ============================================================= -->
    <div class="logo"> <a href="home.html"> <img src="{{ 'assets/website/images/logo.png'}}" alt="logo"> </a> </div>
    <!-- /.logo -->
    <!-- ============================================================= LOGO : END ============================================================= --> </div>
<!-- /.logo-holder -->
...
<div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
    ...
    <ul class="dropdown-menu">
        ...
        <div class="cart-item product-summary">
            <div class="row">
            <div class="col-xs-4">
                <div class="image"> <a href="detail.html"><img src="{{ 'assets/website/images/cart.jpg'}}" alt=""></a> </div>
            </div>
            <div class="col-xs-7">
        ...
        <li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Clothing</a>
            ...
            <li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{{ 'assets/website/images/banners/top-menu-banner.jpg'}}" alt=""> </div>
                    <!-- /.yamm-content -->
                </div>
                </div>
            </li>
        ...
        <a href="category.html"  data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Electronics <span class="menu-label hot-menu hidden-xs">hot</span> </a>
            ...
            <li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="{{ 'assets/website/images/banners/banner-side.png'}}"></a> </div>
                </div>
                <!-- /.row -->
                </div>
                <!-- /.yamm-content --> </li>
...
<div class="clearfix payment-methods">
    <ul>
    <li><img src="{{ 'assets/website/images/payments/1.png'}}" alt=""></li>
    <li><img src="{{ 'assets/website/images/payments/2.png'}}" alt=""></li>
    <li><img src="{{ 'assets/website/images/payments/3.png'}}" alt=""></li>
    <li><img src="{{ 'assets/website/images/payments/4.png'}}" alt=""></li>
    <li><img src="{{ 'assets/website/images/payments/5.png'}}" alt=""></li>
    </ul>
</div>
<!-- /.payment-methods -->
</div>
...
<script src="{{ 'assets/website/js/jquery-1.11.1.min.js' }}"></script>
<script src="{{ 'assets/website/js/bootstrap.min.js' }}"></script>
<script src="{{ 'assets/website/js/bootstrap-hover-dropdown.min.js' }}"></script>
<script src="{{ 'assets/website/js/owl.carousel.min.js' }}"></script>
<script src="{{ 'assets/website/js/echo.min.js' }}"></script>
<script src="{{ 'assets/website/js/jquery.easing-1.3.min.js' }}"></script>
<script src="{{ 'assets/website/js/bootstrap-slider.min.js' }}"></script>
<script src="{{ 'assets/website/js/jquery.rateit.min.js' }}"></script>
